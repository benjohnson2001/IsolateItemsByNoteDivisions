--[[
Description: Isolate items by note divisions
Author: pandabot
License: MIT
Version: 1.0
...
Links:
  ...
  Source repository (GitHub) https://github.com/benjohnson2001/IsolateItemsByNoteDivisions
Metapackage: true
Provides:
    [main] pandabot_Isolate items by note divisions/*.lua
About:
